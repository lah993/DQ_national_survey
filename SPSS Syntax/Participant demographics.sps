...
* Test the sum with frequencies for participant demographic items: gender, education, length_of_employment_range, length_of_employment_range_condensed, appointment, contact_duration_range
